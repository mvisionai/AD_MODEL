...
class Main_run(Dataset_Import):
    ...
    def __init__(self):
        ...
        self.learn_rate_auto = 0.0001
        self.learn_rate_pred = 0.0001
        self.learning_rate_convlayer=0.0001
...
if __name__ == '__main__':
  ...
  #try:
   run_train = Main_run()
   run_train.train(train_type="domain", use_encoder_saver=True, use_train_saver=False)
